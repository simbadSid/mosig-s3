...
#        define LoadFence()            arch_atomic_read_barrier()
#        define StoreFence()           arch_atomic_write_barrier()
#        define FullFence()            arch_atomic_full_barrier()
#	 else
